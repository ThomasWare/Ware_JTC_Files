...
# assigning the string books to the variable box_1.  box_1 = 'books'
# assigning the string clothes to the variable box_2.  box_2 = 'clothes'
# assigning the string plants to the variable box_3. box_3 = 'plants'
# assigning the string kitchen stuff to the variable box_4.  box_4 = 'kitchen stuff'

# printing on one line the print string between the quotes, separated by a space  print('2: Print the variables box_1, box_2, box_3, box_4')
...
print("books", "clothes",  "plants", "Money", "Billionaire")
